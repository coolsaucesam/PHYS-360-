...
print("absolute:", calculateUncertainties(.001, 7.35714755e-05, params40Micrometers[1]), "% uncertainty:", calculateUncertainties(.001, 7.35714755e-05, params40Micrometers[1])/((2*L)/(abs(params40Micrometers[1])*k)))
...
#plotting raw data for 80micrometer slit
ax1.set_title('80μm Data')
